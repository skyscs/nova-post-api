...
| `/system/update` | POST | Ручное обновление данных |
...
API автоматически проверяет обновления NovaPost базы данных каждый день в 2:00 UTC и обновляет локальную базу при появлении новой версии.

Можно также запустить обновление вручную:
```bash
